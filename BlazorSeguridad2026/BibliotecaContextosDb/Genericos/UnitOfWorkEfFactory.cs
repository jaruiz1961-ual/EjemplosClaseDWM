...
namespace BlazorSeguridad2026.Base.Genericos
{
    ...
    public class UnitOfWorkEfFactory : IUnitOfWorkFactory
    {
        private readonly IServiceProvider _provider;

        private readonly IMultiDbContextFactory _map;

        public UnitOfWorkEfFactory(IServiceProvider provider, IContextProvider cp, IMultiDbContextFactory map)
        {
            _provider = provider;
            _map = map;
